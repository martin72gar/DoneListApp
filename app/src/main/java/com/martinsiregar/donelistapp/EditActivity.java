    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Call<SendKontak> updateKontakCall = mApiInterface.putKontak(
                        edtId.getText().toString(),
                        edtNama.getText().toString(),
                        edtNomor.getText().toString());
                updateKontakCall.enqueue(new Callback<SendKontak>() {
                    @Override
        ...
        btDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edtId.getText().toString().trim().isEmpty()==false){
                    Call<SendKontak> deleteKontak = mApiInterface.deleteKontak(edtId.getText().toString());
                    deleteKontak.enqueue(new Callback<SendKontak>() {
                        @Override
                        public void onResponse(Call<SendKontak> call, Response<SendKontak> response) {
                            KontakMainActivity.ma.refresh();
                            finish();
